...
LICENSE: MIT
Author: b4skyx
Source: https://github.com/b4skyx/loan-assistant
*/
...
public class Assistant extends javax.swing.JFrame {
    ...
    // Assistant Form :: Generated by Form Builder
    public Assistant() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel2.setBackground(new java.awt.Color(215, 245, 226));
        ...
        balanceField.setFont(new java.awt.Font("Tahoma", 0, 12));
        balanceField.setToolTipText("Enter the amount that is yet to pay.");
        balanceField.setBorder(javax.swing.BorderFactory.createEtchedBorder(java.awt.Color.darkGray, java.awt.Color.lightGray));
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addComponent(balanceField, javax.swing.GroupLayout.PREFERRED_SIZE, 146, javax.swing.GroupLayout.PREFERRED_SIZE)))
    ...
    private void computePButtonActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        if(validateDecimalNumber(balanceField)) {
            balance = Double.valueOf(balanceField.getText()).doubleValue();
        }
        else {
        ...
        // Caltulate total number of payments
...
JOptionPane.QUESTION_MESSAGE) == JOptionPane.YES_OPTION) {
    ...
    private void computeMButtonActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        finalBalance = loanBalance;
        if (finalBalance > payment) {
            // Apply for additional payment if final balance is greater than payment
    ...
    private boolean validateDecimalNumber(JTextField balance) {
        // Input Validator

        String s = balance.getText().trim();
